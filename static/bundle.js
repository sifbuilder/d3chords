...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
		...
		var d3ringsRendererCourt = __webpack_require__(81);
		var d3ringsRendererLanes = __webpack_require__(82);
		var d3ringsRendererParticles = __webpack_require__(93);
		var d3ringsRendererWhirls = __webpack_require__(94);

		var d3ringsReducer = __webpack_require__(95);
		var d3ringsStore = __webpack_require__(126);
		var d3ringsActions = __webpack_require__(101);
		var d3ringsControls = __webpack_require__(127);
	}
	...
	var KeyDown_Payload = function KeyDown_Payload() {
		...
		if (keys[vKeyCode] == true && keys[altKeyCode] == true) {
			// alt-v
		...
		if (keys[dKeyCode] == true && keys[altKeyCode] == true) {
			// alt-d
		...
		if (keys[leftArrow] == true && keys[ctrlKeyCode] == true) {
			// leftArrow-Ctrl
			console.log("leftArrowCtrlFn");
			store.dispatch(actions.resizeWidth(-10));
		}
		if (keys[rightArrow] == true && keys[ctrlKeyCode] == true) {
			// rightArrow-Ctrl
			console.log("rightArrowCtrlFn");
			store.dispatch(actions.resizeWidth(10));
		}
		if (keys[upArrow] == true && keys[ctrlKeyCode] == true) {
			// upArrow-Ctrl
	...
	/* payloads lanes */
	var setRecords_Payload = function setRecords_Payload() {
		return {
	...
	var setRecordsCollection_Payload = function setRecordsCollection_Payload() {
		return {
	...
	/* payloads particles */
	var createParticles_Payload = function createParticles_Payload() {
		return {
	...
	var introduceParticles_Payload = function introduceParticles_Payload() {
		return {
			particlesPerTick: store.getState().reducerParticles.particlesPerTick,
			x: store.getState().reducerCourt.mousePos[0],
			y: store.getState().reducerCourt.mousePos[1],
	...
	var tickParticles_Payload = function tickParticles_Payload() {
		return {
	...
	/* payloads whirls */
	var createRings_Payload = function createRings_Payload() {
		return {
	...
	var updateRangsDuration_Payload = function updateRangsDuration_Payload() {
		return {
	...
	var updateRangsNumber_Payload = function updateRangsNumber_Payload() {
		return {
			rangsAlways: store.getState().reducerWhirls.rangsAlways,
			rangsHitsIndex: store.getState().reducerWhirls.rangsHitsIndex
		};
	...
	/* launchers */
	var createParticles_Launcher = store.compose(store.dispatch, actions.createParticles, createParticles_Payload);

	var introduceParticles_Launcher = store.compose(store.dispatch, actions.introduceParticles, introduceParticles_Payload);

	var tickParticles_Launcher = store.compose(store.dispatch, actions.tickParticles, tickParticles_Payload);

	var startParticles_Launcher = store.compose(store.dispatch, actions.startParticles);

	var stopParticles_Launcher = store.compose(store.dispatch, actions.stopParticles);

	var setRecordsCollection_Launcher = store.compose(store.dispatch, actions.setRecordsCollection, setRecordsCollection_Payload);

	var setRecords_Launcher = store.compose(store.dispatch, actions.setRecords, setRecords_Payload);

	var startRangs_Launcher = store.compose(store.dispatch, actions.startRangs);

	var stopRangs_Launcher = store.compose(store.dispatch, actions.stopRangs);

	var updateRangsDurationLuncher = store.compose(store.dispatch, actions.updateRangsDuration, updateRangsDuration_Payload);

	var updateRangsNumberLuncher = store.compose(store.dispatch, actions.updateRangsNumber, updateRangsNumber_Payload);

	var createRings_Launcher = store.compose(store.dispatch, actions.createRings, createRings_Payload);

	var startRings_Launcher = store.compose(store.dispatch, actions.startRings);

	var stopRings_Launcher = store.compose(store.dispatch, actions.stopRings);

	var KeyDown_Launcher = store.compose(KeyDown_Payload);

	var setFpsDebug_Launcher = store.compose(store.dispatch, actions.setFps);
	...
	/* launches */
	store.subscribe(store.compose(d3ringsRendererCourt.renderer, store));
	keyDown.subscribe(KeyDown_Launcher);

	ticker.subscribe(setFpsDebug_Launcher);

	store.subscribe(store.compose(d3ringsRendererLanes.renderer, store));
	stepper.subscribe(setRecordsCollection_Launcher);
	stepper.subscribe(setRecords_Launcher);

	store.subscribe(store.compose(d3ringsRendererParticles.renderer, store));
	...
	store.subscribe(store.compose(d3ringsRendererWhirls.renderer, store));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;'use strict';var _log=__webpack_require__(2);var _log2=_interopRequireDefault(_log);var _log3=__webpack_require__(20);var _log4=_interopRequireDefault(_log3);var _stringify=__webpack_require__(23);var _stringify2=_interopRequireDefault(_stringify);var _create=__webpack_require__(25);var _create2=_interopRequireDefault(_create);var _typeof2=__webpack_require__(46);var _typeof3=_interopRequireDefault(_typeof2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}(function(global,factory){( false?'undefined':(0,_typeof3.default)(exports))==='object'&&typeof module!=='undefined'?factory(exports): true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):factory(global.d3=global.d3||{});})(undefined,function(exports){'use strict';var version="4.0.0-alpha.44";function ascending(a,b){return a<b?-1:a>b?1:a>=b?0:NaN;}function bisector(compare){if(compare.length===1)compare=ascendingComparator(compare);return {left:function left(a,x,lo,hi){if(lo==null)lo=0;if(hi==null)hi=a.length;while(lo<hi){var mid=lo+hi>>>1;if(compare(a[mid],x)<0)lo=mid+1;else hi=mid;}return lo;},right:function right(a,x,lo,hi){if(lo==null)lo=0;if(hi==null)hi=a.length;while(lo<hi){var mid=lo+hi>>>1;if(compare(a[mid],x)>0)hi=mid;else lo=mid+1;}return lo;}};}function ascendingComparator(f){return function(d,x){return ascending(f(d),x);};}var ascendingBisect=bisector(ascending);var bisectRight=ascendingBisect.right;var bisectLeft=ascendingBisect.left;function descending(a,b){return b<a?-1:b>a?1:b>=a?0:NaN;}function number(x){return x===null?NaN:+x;}function variance(array,f){var n=array.length,m=0,a,d,s=0,i=-1,j=0;if(f==null){while(++i<n){if(!isNaN(a=number(array[i]))){d=a-m;m+=d/++j;s+=d*(a-m);}}}else {while(++i<n){if(!isNaN(a=number(f(array[i],i,array)))){d=a-m;m+=d/++j;s+=d*(a-m);}}}if(j>1)return s/(j-1);}function deviation(array,f){var v=variance(array,f);return v?Math.sqrt(v):v;}function extent(array,f){var i=-1,n=array.length,a,b,c;if(f==null){while(++i<n){if((b=array[i])!=null&&b>=b){a=c=b;break;}}while(++i<n){if((b=array[i])!=null){if(a>b)a=b;if(c<b)c=b;}}}else {while(++i<n){if((b=f(array[i],i,array))!=null&&b>=b){a=c=b;break;}}while(++i<n){if((b=f(array[i],i,array))!=null){if(a>b)a=b;if(c<b)c=b;}}}return [a,c];}function constant(x){return function(){return x;};}function identity(x){return x;}function sequence(start,stop,step){start=+start,stop=+stop,step=(n=arguments.length)<2?(stop=start,start=0,1):n<3?1:+step;var i=-1,n=Math.max(0,Math.ceil((stop-start)/step))|0,range=new Array(n);while(++i<n){range[i]=start+i*step;}return range;}var e10=Math.sqrt(50);var e5=Math.sqrt(10);var e2=Math.sqrt(2);function ticks(start,stop,count){var step=tickStep(start,stop,count);return sequence(Math.ceil(start/step)*step,Math.floor(stop/step)*step+step/2, // inclusive
	step);}function tickStep(start,stop,count){var step0=Math.abs(stop-start)/Math.max(0,count),step1=Math.pow(10,Math.floor(Math.log(step0)/Math.LN10)),error=step0/step1;if(error>=e10)step1*=10;else if(error>=e5)step1*=5;else if(error>=e2)step1*=2;return stop<start?-step1:step1;}function sturges(values){return Math.ceil(Math.log(values.length)/Math.LN2)+1;}function number$1(x){return +x;}function histogram(){var value=identity,domain=extent,threshold=sturges;function histogram(data){var i,n=data.length,x,values=new Array(n); // Coerce values to numbers.
	for(i=0;i<n;++i){values[i]=+value(data[i],i,data);}var xz=domain(values),x0=+xz[0],x1=+xz[1],tz=threshold(values,x0,x1); // Convert number of thresholds into uniform thresholds.
	if(!Array.isArray(tz))tz=ticks(x0,x1,+tz); // Coerce thresholds to numbers, ignoring any outside the domain.
	var m=tz.length;for(i=0;i<m;++i){tz[i]=+tz[i];}while(tz[0]<=x0){tz.shift(),--m;}while(tz[m-1]>=x1){tz.pop(),--m;}var bins=new Array(m+1),bin; // Initialize bins.
	...
	function cross(a,b,c){return (b[0]-a[0])*(c[1]-a[1])-(b[1]-a[1])*(c[0]-a[0]);}function lexicographicOrder(a,b){return a[0]-b[0]||a[1]-b[1];} // Computes the upper convex hull per the monotone chain algorithm.
	...
	default:this._context.lineTo(x,y);break;}}};function curveLinear(context){return new Linear(context);}function pointX(p){return p[0];}function pointY(p){return p[1];}function area$1(){var x0=pointX,x1=null,y0=constant$1(0),y1=pointY,defined=constant$1(true),context=null,curve=curveLinear,output=null;function area(data){var i,j,k,n=data.length,d,defined0=false,buffer,x0z=new Array(n),y0z=new Array(n);if(context==null)output=curve(buffer=path());for(i=0;i<=n;++i){if(!(i<n&&defined(d=data[i],i,data))===defined0){if(defined0=!defined0){j=i;output.areaStart();output.lineStart();}else {output.lineEnd();output.lineStart();for(k=i-1;k>=j;--k){output.point(x0z[k],y0z[k]);}output.lineEnd();output.areaEnd();}}if(defined0){x0z[i]=+x0(d,i,data),y0z[i]=+y0(d,i,data);output.point(x1?+x1(d,i,data):x0z[i],y1?+y1(d,i,data):y0z[i]);}}if(buffer)return output=null,buffer+""||null;}area.x=function(_){return arguments.length?(x0=typeof _==="function"?_:constant$1(+_),x1=null,area):x0;};area.x0=function(_){return arguments.length?(x0=typeof _==="function"?_:constant$1(+_),area):x0;};area.x1=function(_){return arguments.length?(x1=_==null?null:typeof _==="function"?_:constant$1(+_),area):x1;};area.y=function(_){return arguments.length?(y0=typeof _==="function"?_:constant$1(+_),y1=null,area):y0;};area.y0=function(_){return arguments.length?(y0=typeof _==="function"?_:constant$1(+_),area):y0;};area.y1=function(_){return arguments.length?(y1=_==null?null:typeof _==="function"?_:constant$1(+_),area):y1;};area.defined=function(_){return arguments.length?(defined=typeof _==="function"?_:constant$1(!!_),area):defined;};area.curve=function(_){return arguments.length?(curve=_,context!=null&&(output=curve(context)),area):curve;};area.context=function(_){return arguments.length?(_==null?context=output=null:output=curve(context=_),area):context;};return area;}function line(){var x=pointX,y=pointY,defined=constant$1(true),context=null,curve=curveLinear,output=null;function line(data){var i,n=data.length,d,defined0=false,buffer;if(context==null)output=curve(buffer=path());for(i=0;i<=n;++i){if(!(i<n&&defined(d=data[i],i,data))===defined0){if(defined0=!defined0)output.lineStart();else output.lineEnd();}if(defined0)output.point(+x(d,i,data),+y(d,i,data));}if(buffer)return output=null,buffer+""||null;}line.x=function(_){return arguments.length?(x=typeof _==="function"?_:constant$1(+_),line):x;};line.y=function(_){return arguments.length?(y=typeof _==="function"?_:constant$1(+_),line):y;};line.defined=function(_){return arguments.length?(defined=typeof _==="function"?_:constant$1(!!_),line):defined;};line.curve=function(_){return arguments.length?(curve=_,context!=null&&(output=curve(context)),line):curve;};line.context=function(_){return arguments.length?(_==null?context=output=null:output=curve(context=_),line):context;};return line;}function descending$1(a,b){return b<a?-1:b>a?1:b>=a?0:NaN;}function identity$1(d){return d;}function pie(){var value=identity$1,sortValues=descending$1,sort=null,startAngle=constant$1(0),endAngle=constant$1(tau$2),padAngle=constant$1(0);function pie(data){var i,n=data.length,j,k,sum=0,index=new Array(n),arcs=new Array(n),a0=+startAngle.apply(this,arguments),da=Math.min(tau$2,Math.max(-tau$2,endAngle.apply(this,arguments)-a0)),a1,p=Math.min(Math.abs(da)/n,padAngle.apply(this,arguments)),pa=p*(da<0?-1:1),v;for(i=0;i<n;++i){if((v=arcs[index[i]=i]=+value(data[i],i,data))>0){sum+=v;}} // Optionally sort the arcs by previously-computed values or by data.
	...
	switch(this._point){case 0:this._point=1;this._line?this._context.lineTo(x,y):this._context.moveTo(x,y);break;case 1:this._point=2;break;case 2:this._point=3;point$3(this,slope2(this,t1=slope3(this,x,y)),t1);break;default:point$3(this,this._t0,t1=slope3(this,x,y));break;}this._x0=this._x1,this._x1=x;this._y0=this._y1,this._y1=y;this._t0=t1;}};function MonotoneY(context){this._context=new ReflectContext(context);}(MonotoneY.prototype=(0,_create2.default)(MonotoneX.prototype)).point=function(x,y){MonotoneX.prototype.point.call(this,y,x);};function ReflectContext(context){this._context=context;}ReflectContext.prototype={moveTo:function moveTo(x,y){this._context.moveTo(y,x);},closePath:function closePath(){this._context.closePath();},lineTo:function lineTo(x,y){this._context.lineTo(y,x);},bezierCurveTo:function bezierCurveTo(x1,y1,x2,y2,x,y){this._context.bezierCurveTo(y1,x1,y2,x2,y,x);}};function monotoneX(context){return new MonotoneX(context);}function monotoneY(context){return new MonotoneY(context);}function Natural(context){this._context=context;}Natural.prototype={areaStart:function areaStart(){this._line=0;},areaEnd:function areaEnd(){this._line=NaN;},lineStart:function lineStart(){this._x=[];this._y=[];},lineEnd:function lineEnd(){var x=this._x,y=this._y,n=x.length;if(n){this._line?this._context.lineTo(x[0],y[0]):this._context.moveTo(x[0],y[0]);if(n===2){this._context.lineTo(x[1],y[1]);}else {var px=controlPoints(x),py=controlPoints(y);for(var i0=0,i1=1;i1<n;++i0,++i1){this._context.bezierCurveTo(px[0][i0],py[0][i0],px[1][i0],py[1][i0],x[i1],y[i1]);}}}if(this._line||this._line!==0&&n===1)this._context.closePath();this._line=1-this._line;this._x=this._y=null;},point:function point(x,y){this._x.push(+x);this._y.push(+y);}}; // See https://www.particleincell.com/2012/bezier-splines/ for derivation.
	...
	return function(t){var i=-1,n=q.length,o;while(++i<n){s[(o=q[i]).i]=o.x(t);}return s.join("");};};}var interpolateTransform$1=interpolateTransform(parseCss,"px, ","px)","deg)");var interpolateTransform$2=interpolateTransform(parseSvg,", ",")",")");var rho=Math.SQRT2;var rho2=2;var rho4=4;var epsilon2=1e-12;function cosh(x){return ((x=Math.exp(x))+1/x)/2;}function sinh(x){return ((x=Math.exp(x))-1/x)/2;}function tanh(x){return ((x=Math.exp(2*x))-1)/(x+1);} // p0 = [ux0, uy0, w0]
	// p1 = [ux1, uy1, w1]
	...
	else {var d1=Math.sqrt(d2),b0=(w1*w1-w0*w0+rho4*d2)/(2*w0*rho2*d1),b1=(w1*w1-w0*w0-rho4*d2)/(2*w1*rho2*d1),r0=Math.log(Math.sqrt(b0*b0+1)-b0),r1=Math.log(Math.sqrt(b1*b1+1)-b1);S=(r1-r0)/rho;i=function i(t){var s=t*S,coshr0=cosh(r0),u=w0/(rho2*d1)*(coshr0*tanh(rho*s+r0)-sinh(r0));return [ux0+u*dx,uy0+u*dy,w0*coshr0/cosh(rho*s+r0)];};}i.duration=S*1000;return i;}function interpolateHsl(start,end){var h=interpolateHue((start=hsl(start)).h,(end=hsl(end)).h),s=nogamma(start.s,end.s),l=nogamma(start.l,end.l),opacity=nogamma(start.opacity,end.opacity);return function(t){start.h=h(t);start.s=s(t);start.l=l(t);start.opacity=opacity(t);return start+"";};}function interpolateHslLong(start,end){var h=nogamma((start=hsl(start)).h,(end=hsl(end)).h),s=nogamma(start.s,end.s),l=nogamma(start.l,end.l),opacity=nogamma(start.opacity,end.opacity);return function(t){start.h=h(t);start.s=s(t);start.l=l(t);start.opacity=opacity(t);return start+"";};}function interpolateLab(start,end){var l=nogamma((start=lab(start)).l,(end=lab(end)).l),a=nogamma(start.a,end.a),b=nogamma(start.b,end.b),opacity=nogamma(start.opacity,end.opacity);return function(t){start.l=l(t);start.a=a(t);start.b=b(t);start.opacity=opacity(t);return start+"";};}function interpolateHcl(start,end){var h=interpolateHue((start=hcl(start)).h,(end=hcl(end)).h),c=nogamma(start.c,end.c),l=nogamma(start.l,end.l),opacity=nogamma(start.opacity,end.opacity);return function(t){start.h=h(t);start.c=c(t);start.l=l(t);start.opacity=opacity(t);return start+"";};}function interpolateHclLong(start,end){var h=nogamma((start=hcl(start)).h,(end=hcl(end)).h),c=nogamma(start.c,end.c),l=nogamma(start.l,end.l),opacity=nogamma(start.opacity,end.opacity);return function(t){start.h=h(t);start.c=c(t);start.l=l(t);start.opacity=opacity(t);return start+"";};}var cubehelix$1=function gamma(y){y=+y;function interpolateCubehelix(start,end){var h=interpolateHue((start=cubehelix(start)).h,(end=cubehelix(end)).h),s=nogamma(start.s,end.s),l=nogamma(start.l,end.l),opacity=nogamma(start.opacity,end.opacity);return function(t){start.h=h(t);start.s=s(t);start.l=l(Math.pow(t,y));start.opacity=opacity(t);return start+"";};}interpolateCubehelix.gamma=gamma;return interpolateCubehelix;}(1);var interpolateCubehelixLong=function gamma(y){y=+y;function interpolateCubehelixLong(start,end){var h=nogamma((start=cubehelix(start)).h,(end=cubehelix(end)).h),s=nogamma(start.s,end.s),l=nogamma(start.l,end.l),opacity=nogamma(start.opacity,end.opacity);return function(t){start.h=h(t);start.s=s(t);start.l=l(Math.pow(t,y));start.opacity=opacity(t);return start+"";};}interpolateCubehelixLong.gamma=gamma;return interpolateCubehelixLong;}(1);var noop$1={value:function value(){}};function dispatch(){for(var i=0,n=arguments.length,_={},t;i<n;++i){if(!(t=arguments[i]+"")||t in _)throw new Error();_[t]=[];}return new Dispatch(_);}function Dispatch(_){this._=_;}function parseTypenames(typenames,types){return typenames.trim().split(/^|\s+/).map(function(t){var name="",i=t.indexOf(".");if(i>=0)name=t.slice(i+1),t=t.slice(0,i);if(t&&!types.hasOwnProperty(t))throw new Error();return {type:t,name:name};});}Dispatch.prototype=dispatch.prototype={constructor:Dispatch,on:function on(typename,callback){var _=this._,T=parseTypenames(typename+"",_),t,i=-1,n=T.length; // If no callback was specified, return the callback of the given type and name.
	...
	if(callback!=null&&typeof callback!=="function")throw new Error();while(++i<n){if(t=(typename=T[i]).type)_[t]=set$1(_[t],typename.name,callback);else if(callback==null)for(t in _){_[t]=set$1(_[t],typename.name,null);}}return this;},copy:function copy(){var copy={},_=this._;for(var t in _){copy[t]=_[t].slice();}return new Dispatch(copy);},call:function call(type,that){if((n=arguments.length-2)>0)for(var args=new Array(n),i=0,n;i<n;++i){args[i]=arguments[i+2];}this.apply(type,that,args);},apply:function apply(type,that,args){if(!this._.hasOwnProperty(type))throw new Error();for(var t=this._[type],i=0,n=t.length;i<n;++i){t[i].value.apply(that,args);}}};function get(type,name){for(var i=0,n=type.length,c;i<n;++i){if((c=type[i]).name===name){return c.value;}}}function set$1(type,name,callback){for(var i=0,n=type.length;i<n;++i){if(type[i].name===name){type[i]=noop$1,type=type.slice(0,i).concat(type.slice(i+1));break;}}if(callback!=null)type.push({name:name,value:callback});return type;}function objectConverter(columns){return new Function("d","return {"+columns.map(function(name,i){return (0,_stringify2.default)(name)+": d["+i+"]";}).join(",")+"}");}function customConverter(columns,f){var object=objectConverter(columns);return function(row,i){return f(object(row),i,columns);};} // Compute unique columns in order of discovery.
	function inferColumns(rows){var columnSet=(0,_create2.default)(null),columns=[];rows.forEach(function(row){for(var column in row){if(!(column in columnSet)){columns.push(columnSet[column]=column);}}});return columns;}function dsv(delimiter){var reFormat=new RegExp("[\""+delimiter+"\n]"),delimiterCode=delimiter.charCodeAt(0);function parse(text,f){var convert,columns,rows=parseRows(text,function(row,i){if(convert)return convert(row,i-1);columns=row,convert=f?customConverter(row,f):objectConverter(row);});rows.columns=columns;return rows;}function parseRows(text,f){var EOL={}, // sentinel value for end-of-line
	...
	millisecond.every=function(k){k=Math.floor(k);if(!isFinite(k)||!(k>0))return null;if(!(k>1))return millisecond;return newInterval(function(date){date.setTime(Math.floor(date/k)*k);},function(date,step){date.setTime(+date+step*k);},function(start,end){return (end-start)/k;});};var second=1e3;var minute=6e4;var hour=36e5;var day=864e5;var week=6048e5;var timeSecond=newInterval(function(date){date.setTime(Math.floor(date/second)*second);},function(date,step){date.setTime(+date+step*second);},function(start,end){return (end-start)/second;},function(date){return date.getUTCSeconds();});var timeMinute=newInterval(function(date){date.setTime(Math.floor(date/minute)*minute);},function(date,step){date.setTime(+date+step*minute);},function(start,end){return (end-start)/minute;},function(date){return date.getMinutes();});var timeHour=newInterval(function(date){var offset=date.getTimezoneOffset()*minute%hour;if(offset<0)offset+=hour;date.setTime(Math.floor((+date-offset)/hour)*hour+offset);},function(date,step){date.setTime(+date+step*hour);},function(start,end){return (end-start)/hour;},function(date){return date.getHours();});var timeDay=newInterval(function(date){date.setHours(0,0,0,0);},function(date,step){date.setDate(date.getDate()+step);},function(start,end){return (end-start-(end.getTimezoneOffset()-start.getTimezoneOffset())*minute)/day;},function(date){return date.getDate()-1;});function weekday(i){return newInterval(function(date){date.setHours(0,0,0,0);date.setDate(date.getDate()-(date.getDay()+7-i)%7);},function(date,step){date.setDate(date.getDate()+step*7);},function(start,end){return (end-start-(end.getTimezoneOffset()-start.getTimezoneOffset())*minute)/week;});}var timeSunday=weekday(0);var timeMonday=weekday(1);var tuesday=weekday(2);var wednesday=weekday(3);var thursday=weekday(4);var friday=weekday(5);var saturday=weekday(6);var timeMonth=newInterval(function(date){date.setHours(0,0,0,0);date.setDate(1);},function(date,step){date.setMonth(date.getMonth()+step);},function(start,end){return end.getMonth()-start.getMonth()+(end.getFullYear()-start.getFullYear())*12;},function(date){return date.getMonth();});var timeYear=newInterval(function(date){date.setHours(0,0,0,0);date.setMonth(0,1);},function(date,step){date.setFullYear(date.getFullYear()+step);},function(start,end){return end.getFullYear()-start.getFullYear();},function(date){return date.getFullYear();});var utcMinute=newInterval(function(date){date.setUTCSeconds(0,0);},function(date,step){date.setTime(+date+step*minute);},function(start,end){return (end-start)/minute;},function(date){return date.getUTCMinutes();});var utcHour=newInterval(function(date){date.setUTCMinutes(0,0,0);},function(date,step){date.setTime(+date+step*hour);},function(start,end){return (end-start)/hour;},function(date){return date.getUTCHours();});var utcDay=newInterval(function(date){date.setUTCHours(0,0,0,0);},function(date,step){date.setUTCDate(date.getUTCDate()+step);},function(start,end){return (end-start)/day;},function(date){return date.getUTCDate()-1;});function utcWeekday(i){return newInterval(function(date){date.setUTCHours(0,0,0,0);date.setUTCDate(date.getUTCDate()-(date.getUTCDay()+7-i)%7);},function(date,step){date.setUTCDate(date.getUTCDate()+step*7);},function(start,end){return (end-start)/week;});}var utcSunday=utcWeekday(0);var utcMonday=utcWeekday(1);var utcTuesday=utcWeekday(2);var utcWednesday=utcWeekday(3);var utcThursday=utcWeekday(4);var utcFriday=utcWeekday(5);var utcSaturday=utcWeekday(6);var utcMonth=newInterval(function(date){date.setUTCHours(0,0,0,0);date.setUTCDate(1);},function(date,step){date.setUTCMonth(date.getUTCMonth()+step);},function(start,end){return end.getUTCMonth()-start.getUTCMonth()+(end.getUTCFullYear()-start.getUTCFullYear())*12;},function(date){return date.getUTCMonth();});var utcYear=newInterval(function(date){date.setUTCHours(0,0,0,0);date.setUTCMonth(0,1);},function(date,step){date.setUTCFullYear(date.getUTCFullYear()+step);},function(start,end){return end.getUTCFullYear()-start.getUTCFullYear();},function(date){return date.getUTCFullYear();});var timeMilliseconds=millisecond.range;var timeSeconds=timeSecond.range;var timeMinutes=timeMinute.range;var timeHours=timeHour.range;var timeDays=timeDay.range;var timeSundays=timeSunday.range;var timeMondays=timeMonday.range;var timeTuesdays=tuesday.range;var timeWednesdays=wednesday.range;var timeThursdays=thursday.range;var timeFridays=friday.range;var timeSaturdays=saturday.range;var timeWeeks=timeSunday.range;var timeMonths=timeMonth.range;var timeYears=timeYear.range;var utcMillisecond=millisecond;var utcMilliseconds=timeMilliseconds;var utcSecond=timeSecond;var utcSeconds=timeSeconds;var utcMinutes=utcMinute.range;var utcHours=utcHour.range;var utcDays=utcDay.range;var utcSundays=utcSunday.range;var utcMondays=utcMonday.range;var utcTuesdays=utcTuesday.range;var utcWednesdays=utcWednesday.range;var utcThursdays=utcThursday.range;var utcFridays=utcFriday.range;var utcSaturdays=utcSaturday.range;var utcWeeks=utcSunday.range;var utcMonths=utcMonth.range;var utcYears=utcYear.range; // Computes the decimal coefficient and exponent of the specified number x with
	...
	var re=/^(?:(.)?([<>=^]))?([+\-\( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?([a-z%])?$/i;function formatSpecifier(specifier){return new FormatSpecifier(specifier);}function FormatSpecifier(specifier){if(!(match=re.exec(specifier)))throw new Error("invalid format: "+specifier);var match,fill=match[1]||" ",align=match[2]||">",sign=match[3]||"-",symbol=match[4]||"",zero=!!match[5],width=match[6]&&+match[6],comma=!!match[7],precision=match[8]&&+match[8].slice(1),type=match[9]||""; // The "n" type is an alias for ",g".
	...
	if(zero||fill==="0"&&align==="=")zero=true,fill="0",align="=";this.fill=fill;this.align=align;this.sign=sign;this.symbol=symbol;this.zero=zero;this.width=width;this.comma=comma;this.precision=precision;this.type=type;}FormatSpecifier.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width==null?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision==null?"":"."+Math.max(0,this.precision|0))+this.type;};var prefixes=["y","z","a","f","p","n","�","m","","k","M","G","T","P","E","Z","Y"];function identity$3(x){return x;}function locale(locale){var group=locale.grouping&&locale.thousands?formatGroup(locale.grouping,locale.thousands):identity$3,currency=locale.currency,decimal=locale.decimal;function newFormat(specifier){specifier=formatSpecifier(specifier);var fill=specifier.fill,align=specifier.align,sign=specifier.sign,symbol=specifier.symbol,zero=specifier.zero,width=specifier.width,comma=specifier.comma,precision=specifier.precision,type=specifier.type; // Compute the prefix and suffix.
	...
	switch(align){case "<":return valuePrefix+value+valueSuffix+padding;case "=":return valuePrefix+padding+value+valueSuffix;case "^":return padding.slice(0,length=padding.length>>1)+valuePrefix+value+valueSuffix+padding.slice(length);}return padding+valuePrefix+value+valueSuffix;}format.toString=function(){return specifier+"";};return format;}function formatPrefix(specifier,value){var f=newFormat((specifier=formatSpecifier(specifier),specifier.type="f",specifier)),e=Math.max(-8,Math.min(8,Math.floor(exponent$1(value)/3)))*3,k=Math.pow(10,-e),prefix=prefixes[8+e/3];return function(value){return f(k*value)+prefix;};}return {format:newFormat,formatPrefix:formatPrefix};}var defaultLocale=locale({decimal:".",thousands:",",grouping:[3],currency:["$",""]});var caES=locale({decimal:",",thousands:".",grouping:[3],currency:["","\xa0�"]});var csCZ=locale({decimal:",",thousands:"\xa0",grouping:[3],currency:["","\xa0Kc"]});var deCH=locale({decimal:",",thousands:"'",grouping:[3],currency:["","\xa0CHF"]});var deDE=locale({decimal:",",thousands:".",grouping:[3],currency:["","\xa0�"]});var enCA=locale({decimal:".",thousands:",",grouping:[3],currency:["$",""]});var enGB=locale({decimal:".",thousands:",",grouping:[3],currency:["�",""]});var esES=locale({decimal:",",thousands:".",grouping:[3],currency:["","\xa0�"]});var fiFI=locale({decimal:",",thousands:"\xa0",grouping:[3],currency:["","\xa0�"]});var frCA=locale({decimal:",",thousands:"\xa0",grouping:[3],currency:["","$"]});var frFR=locale({decimal:",",thousands:".",grouping:[3],currency:["","\xa0�"]});var heIL=locale({decimal:".",thousands:",",grouping:[3],currency:["?",""]});var huHU=locale({decimal:",",thousands:"\xa0",grouping:[3],currency:["","\xa0Ft"]});var itIT=locale({decimal:",",thousands:".",grouping:[3],currency:["�",""]});var jaJP=locale({decimal:".",thousands:",",grouping:[3],currency:["","?"]});var koKR=locale({decimal:".",thousands:",",grouping:[3],currency:["?",""]});var mkMK=locale({decimal:",",thousands:".",grouping:[3],currency:["","\xa0???."]});var nlNL=locale({decimal:",",thousands:".",grouping:[3],currency:["�\xa0",""]});var plPL=locale({decimal:",",thousands:".",grouping:[3],currency:["","zl"]});var ptBR=locale({decimal:",",thousands:".",grouping:[3],currency:["R$",""]});var ruRU=locale({decimal:",",thousands:"\xa0",grouping:[3],currency:["","\xa0???."]});var svSE=locale({decimal:",",thousands:"\xa0",grouping:[3],currency:["","SEK"]});var zhCN=locale({decimal:".",thousands:",",grouping:[3],currency:["�",""]});function precisionFixed(step){return Math.max(0,-exponent$1(Math.abs(step)));}function precisionPrefix(step,value){return Math.max(0,Math.max(-8,Math.min(8,Math.floor(exponent$1(value)/3)))*3-exponent$1(Math.abs(step)));}function precisionRound(step,max){step=Math.abs(step),max=Math.abs(max)-step;return Math.max(0,exponent$1(max)-exponent$1(step))+1;}var format=defaultLocale.format;var formatPrefix=defaultLocale.formatPrefix;function localDate(d){if(0<=d.y&&d.y<100){var date=new Date(-1,d.m,d.d,d.H,d.M,d.S,d.L);date.setFullYear(d.y);return date;}return new Date(d.y,d.m,d.d,d.H,d.M,d.S,d.L);}function utcDate(d){if(0<=d.y&&d.y<100){var date=new Date(Date.UTC(-1,d.m,d.d,d.H,d.M,d.S,d.L));date.setUTCFullYear(d.y);return date;}return new Date(Date.UTC(d.y,d.m,d.d,d.H,d.M,d.S,d.L));}function newYear(y){return {y:y,m:0,d:1,H:0,M:0,S:0,L:0};}function locale$2(locale){var locale_dateTime=locale.dateTime,locale_date=locale.date,locale_time=locale.time,locale_periods=locale.periods,locale_weekdays=locale.days,locale_shortWeekdays=locale.shortDays,locale_months=locale.months,locale_shortMonths=locale.shortMonths;var periodRe=formatRe(locale_periods),periodLookup=formatLookup(locale_periods),weekdayRe=formatRe(locale_weekdays),weekdayLookup=formatLookup(locale_weekdays),shortWeekdayRe=formatRe(locale_shortWeekdays),shortWeekdayLookup=formatLookup(locale_shortWeekdays),monthRe=formatRe(locale_months),monthLookup=formatLookup(locale_months),shortMonthRe=formatRe(locale_shortMonths),shortMonthLookup=formatLookup(locale_shortMonths);var formats={"a":formatShortWeekday,"A":formatWeekday,"b":formatShortMonth,"B":formatMonth,"c":null,"d":formatDayOfMonth,"e":formatDayOfMonth,"H":formatHour24,"I":formatHour12,"j":formatDayOfYear,"L":formatMilliseconds,"m":formatMonthNumber,"M":formatMinutes,"p":formatPeriod,"S":formatSeconds,"U":formatWeekNumberSunday,"w":formatWeekdayNumber,"W":formatWeekNumberMonday,"x":null,"X":null,"y":formatYear,"Y":formatFullYear,"Z":formatZone,"%":formatLiteralPercent};var utcFormats={"a":formatUTCShortWeekday,"A":formatUTCWeekday,"b":formatUTCShortMonth,"B":formatUTCMonth,"c":null,"d":formatUTCDayOfMonth,"e":formatUTCDayOfMonth,"H":formatUTCHour24,"I":formatUTCHour12,"j":formatUTCDayOfYear,"L":formatUTCMilliseconds,"m":formatUTCMonthNumber,"M":formatUTCMinutes,"p":formatUTCPeriod,"S":formatUTCSeconds,"U":formatUTCWeekNumberSunday,"w":formatUTCWeekdayNumber,"W":formatUTCWeekNumberMonday,"x":null,"X":null,"y":formatUTCYear,"Y":formatUTCFullYear,"Z":formatUTCZone,"%":formatLiteralPercent};var parses={"a":parseShortWeekday,"A":parseWeekday,"b":parseShortMonth,"B":parseMonth,"c":parseLocaleDateTime,"d":parseDayOfMonth,"e":parseDayOfMonth,"H":parseHour24,"I":parseHour24,"j":parseDayOfYear,"L":parseMilliseconds,"m":parseMonthNumber,"M":parseMinutes,"p":parsePeriod,"S":parseSeconds,"U":parseWeekNumberSunday,"w":parseWeekdayNumber,"W":parseWeekNumberMonday,"x":parseLocaleDate,"X":parseLocaleTime,"y":parseYear,"Y":parseFullYear,"Z":parseZone,"%":parseLiteralPercent}; // These recursive directive definitions must be deferred.
	...
	schedules[id]=self;self.timer=timer(schedule,0,self.time); // If the delay is greater than this first sleep, sleep some more;
	// otherwise, start immediately.
	function schedule(elapsed){self.state=SCHEDULED;if(self.delay<=elapsed)start(elapsed-self.delay);else self.timer.restart(start,self.delay,self.time);}function start(elapsed){var i,j,n,o;for(i in schedules){o=schedules[i];if(o.name!==self.name)continue; // Interrupt the active transition, if any.
	// Dispatch the interrupt event.
	if(o.state===STARTED){o.state=ENDED;o.timer.stop();o.on.call("interrupt",node,node.__data__,o.index,o.group);delete schedules[i];} // Cancel any pre-empted transitions. No interrupt event is dispatched
	// because the cancelled transitions never started. Note that this also
	// removes this transition from the pending list!
	else if(+i<id){o.state=ENDED;o.timer.stop();delete schedules[i];}} // Defer the first tick to end of the current frame; see mbostock/d3#1576.
	// Note the transition may be canceled after start and before the first tick!
	// Note this must be scheduled before the start event; see d3/d3-transition#16!
	// Assuming this is successful, subsequent callbacks go straight to tick.
	timeout$1(function(){if(self.state===STARTED){self.timer.restart(tick,self.delay,self.time);tick(elapsed);}}); // Dispatch the start event.
	...
	function apportion(v,w,ancestor){if(w){var vip=v,vop=v,vim=w,vom=vip.parent.children[0],sip=vip.m,sop=vop.m,sim=vim.m,som=vom.m,shift;while(vim=nextRight(vim),vip=nextLeft(vip),vim&&vip){vom=nextLeft(vom);vop=nextRight(vop);vop.a=v;shift=vim.z+sim-vip.z-sip+separation(vim._,vip._);if(shift>0){moveSubtree(nextAncestor(vim,v,ancestor),v,shift);sip+=shift;sop+=shift;}sim+=vim.m;sip+=vip.m;som+=vom.m;sop+=vop.m;}if(vim&&!nextRight(vop)){vop.t=vim;vop.m+=sim-sop;}if(vip&&!nextLeft(vom)){vom.t=vip;vom.m+=sip-som;ancestor=v;}}return ancestor;}function sizeNode(node){node.x*=dx;node.y=node.depth*dy;}tree.separation=function(x){return arguments.length?(separation=x,tree):separation;};tree.size=function(x){return arguments.length?(nodeSize=false,dx=+x[0],dy=+x[1],tree):nodeSize?null:[dx,dy];};tree.nodeSize=function(x){return arguments.length?(nodeSize=true,dx=+x[0],dy=+x[1],tree):nodeSize?[dx,dy]:null;};return tree;}function slice$4(parent,x0,y0,x1,y1){var nodes=parent.children,node,i=-1,n=nodes.length,k=parent.value&&(y1-y0)/parent.value;while(++i<n){node=nodes[i],node.x0=x0,node.x1=x1;node.y0=y0,node.y1=y0+=node.value*k;}}var squarify=function custom(ratio){function squarify(parent,x0,y0,x1,y1){if(parent._squarify)return resquarify(parent,x0,y0,x1,y1);var squarified=parent._squarify=[],nodes=parent.children,row,nodeValue,i0=0,i1,n=nodes.length,dx,dy,value=parent.value,sumValue,minValue,maxValue,newRatio,minRatio,alpha,beta;while(i0<n){dx=x1-x0,dy=y1-y0;minValue=maxValue=sumValue=nodes[i0].value;alpha=Math.max(dy/dx,dx/dy)/(value*ratio);beta=sumValue*sumValue*alpha;minRatio=Math.max(maxValue/beta,beta/minValue); // Keep adding nodes while the aspect ratio maintains or improves.
	...
	function clippedEdge(edge,x0,y0,x1,y1){var a=edge[0],b=edge[1],ax=a[0],ay=a[1],bx=b[0],by=b[1],t0=0,t1=1,dx=bx-ax,dy=by-ay,l,r;r=x0-ax;if(!dx&&r>0)return;r/=dx;if(dx<0){if(r<t0)return;if(r<t1)t1=r;}else if(dx>0){if(r>t1)return;if(r>t0)t0=r;}r=x1-ax;if(!dx&&r<0)return;r/=dx;if(dx<0){if(r>t1)return;if(r>t0)t0=r;}else if(dx>0){if(r<t0)return;if(r<t1)t1=r;}r=y0-ay;if(!dy&&r>0)return;r/=dy;if(dy<0){if(r<t0)return;if(r<t1)t1=r;}else if(dy>0){if(r>t1)return;if(r>t0)t0=r;}r=y1-ay;if(!dy&&r<0)return;r/=dy;if(dy<0){if(r>t1)return;if(r>t0)t0=r;}else if(dy>0){if(r<t0)return;if(r<t1)t1=r;}if(!(t0>0)&&!(t1<1))return edge; // TODO Better check?
	l=edge.left,r=edge.right;if(t0>0)a=[ax+t0*dx,ay+t0*dy];if(t1<1)b=[ax+t1*dx,ay+t1*dy];edge=[a,b];edge.left=l;edge.right=r;return edge;}function connectedEdge(edge,x0,y0,x1,y1){var v1=edge[1];if(v1)return edge;var v0=edge[0],left=edge.left,right=edge.right,lx=left[0],ly=left[1],rx=right[0],ry=right[1],fx=(lx+rx)/2,fy=(ly+ry)/2,fm,fb;if(ry===ly){if(fx<x0||fx>=x1)return;if(lx>rx){if(!v0)v0=[fx,y0];else if(v0[1]>=y1)return;v1=[fx,y1];}else {if(!v0)v0=[fx,y1];else if(v0[1]<y0)return;v1=[fx,y0];}}else {fm=(lx-rx)/(ry-ly);fb=fy-fm*fx;if(fm<-1||fm>1){if(lx>rx){if(!v0)v0=[(y0-fb)/fm,y0];else if(v0[1]>=y1)return;v1=[(y1-fb)/fm,y1];}else {if(!v0)v0=[(y1-fb)/fm,y1];else if(v0[1]<y0)return;v1=[(y0-fb)/fm,y0];}}else {if(ly<ry){if(!v0)v0=[x0,fm*x0+fb];else if(v0[0]>=x1)return;v1=[x1,fm*x1+fb];}else {if(!v0)v0=[x1,fm*x1+fb];else if(v0[0]<x0)return;v1=[x0,fm*x0+fb];}}}edge=[v0,v1];edge.left=left;edge.right=right;return edge;}function clippedEdges(x0,y0,x1,y1){var i=edges.length,clippedEdges=new Array(i),edge;while(i--){if((edge=connectedEdge(edges[i],x0,y0,x1,y1))&&(edge=clippedEdge(edge,x0,y0,x1,y1))&&(Math.abs(edge[0][0]-edge[1][0])>epsilon$3||Math.abs(edge[0][1]-edge[1][1])>epsilon$3)){clippedEdges[i]=edge;}}return clippedEdges;}function createCell(site){return cells[site.index]={site:site,halfedges:[]};}function cellHalfedgeAngle(cell,edge){var site=cell.site,va=edge.left,vb=edge.right;if(site===vb)vb=va,va=site;if(vb)return Math.atan2(vb[1]-va[1],vb[0]-va[0]);if(site===va)va=edge[1],vb=edge[0];else va=edge[0],vb=edge[1];return Math.atan2(va[0]-vb[0],vb[1]-va[1]);}function cellHalfedgeStart(cell,edge){return edge[+(edge.left!==cell.site)];}function cellHalfedgeEnd(cell,edge){return edge[+(edge.left===cell.site)];}function sortCellHalfedges(){for(var i=0,n=cells.length,cell,halfedges,j,m;i<n;++i){if((cell=cells[i])&&(m=(halfedges=cell.halfedges).length)){var index=new Array(m),array=new Array(m);for(j=0;j<m;++j){index[j]=j,array[j]=cellHalfedgeAngle(cell,edges[halfedges[j]]);}index.sort(function(i,j){return array[j]-array[i];});for(j=0;j<m;++j){array[j]=halfedges[index[j]];}for(j=0;j<m;++j){halfedges[j]=array[j];}}}}function clipCells(edges,x0,y0,x1,y1){var iCell=cells.length,cell,iHalfedge,halfedges,nHalfedges,start,startX,startY,end,endX,endY;while(iCell--){if(cell=cells[iCell]){halfedges=cell.halfedges;iHalfedge=halfedges.length; // Remove any dangling clipped edges.
	while(iHalfedge--){if(!edges[halfedges[iHalfedge]]){halfedges.splice(iHalfedge,1);}} // Insert any border edges as necessary.
	iHalfedge=0,nHalfedges=halfedges.length;while(iHalfedge<nHalfedges){end=cellHalfedgeEnd(cell,edges[halfedges[iHalfedge]]),endX=end[0],endY=end[1];start=cellHalfedgeStart(cell,edges[halfedges[++iHalfedge%nHalfedges]]),startX=start[0],startY=start[1];if(Math.abs(endX-startX)>epsilon$3||Math.abs(endY-startY)>epsilon$3){halfedges.splice(iHalfedge,0,edges.push(createBorderEdge(cell.site,end,Math.abs(endX-x0)<epsilon$3&&y1-endY>epsilon$3?[x0,Math.abs(startX-x0)<epsilon$3?startY:y1]:Math.abs(endY-y1)<epsilon$3&&x1-endX>epsilon$3?[Math.abs(startY-y1)<epsilon$3?startX:x1,y1]:Math.abs(endX-x1)<epsilon$3&&endY-y0>epsilon$3?[x1,Math.abs(startX-x1)<epsilon$3?startY:y0]:Math.abs(endY-y0)<epsilon$3&&endX-x0>epsilon$3?[Math.abs(startY-y0)<epsilon$3?startX:x0,y0]:null))-1);++nHalfedges;}}}}}var circlePool=[];var firstCircle;function Circle(){RedBlackNode(this);this.x=this.y=this.arc=this.site=this.cy=null;}function attachCircle(arc){var lArc=arc.P,rArc=arc.N;if(!lArc||!rArc)return;var lSite=lArc.site,cSite=arc.site,rSite=rArc.site;if(lSite===rSite)return;var bx=cSite[0],by=cSite[1],ax=lSite[0]-bx,ay=lSite[1]-by,cx=rSite[0]-bx,cy=rSite[1]-by;var d=2*(ax*cy-ay*cx);if(d>=-epsilon2$1)return;var ha=ax*ax+ay*ay,hc=cx*cx+cy*cy,x=(cy*ha-ay*hc)/d,y=(ax*hc-cx*ha)/d;var circle=circlePool.pop()||new Circle();circle.arc=arc;circle.site=cSite;circle.x=x+bx;circle.y=(circle.cy=y+by)+Math.sqrt(x*x+y*y); // y bottom
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsRendererCourt = global.d3ringsRendererCourt || {});
		...
		function renderer(store) {
			...
			function doRender(newState) {
				...
				var svgContainer = d3.select(state.reducerConfig.containerElem).selectAll('svg').data(['svg']);

				var svgContainerNew = svgContainer.enter().append("svg").attr("id", state.reducerConfig.containerId).style('width', state.reducerCourt.svgWidth).style('height', state.reducerCourt.svgHeight).attr('class', 'bar-chart') //
				.style('border', '1px solid red').style('color', 'blue').attr('viewbox', "0 0 3 2");

				var svg = d3.select('svg');

				var itemsGroup = d3.select('svg').selectAll('g.notices') // items
				.data(['items']);

				itemsGroup.enter().append("g").classed("notices", true); // items
				...
				if (currentView == 'lanesView') {
					...
					noticeToShow = noticeToShow + cmdsLanes + " - " + currentView + " - n: " + particlesNow + " - fps: " + framesPerSecond;
				}
				if (currentView == 'ringsView') {
					noticeToShow = noticeToShow + (startRangs ? '' : ' MOUSE PLEASE !!! ') + ' you already missed ' + hitsLostPct + ' % of your ' + rangsAlways + ' rings' + ' and ' + framesLostPct + ' % of your  frames ' + '!!! ' + '  (' + 'try alt-v' + ')';
				}
				...
				// items elems
				var itemsElems = svgContainer.select("g.notices").selectAll("g.notice").data([noticeToShow]);

				// items elems enter
				var itemsElemsNew = itemsElems.enter().append("g").classed("notice", true);

				itemsElemsNew.each(function (d, i) {
					var itemElemNew = d3.select(this).append("text").classed("info", true).style("font-family", fontname).attr("x", function (d) {
						return hlocation;
					}).attr("y", function (d) {
						return vlocation;
				...
				// items elems update
				itemsElems.select('text').text(function (d) {
					return d;
				}).attr("x", function (d) {
					return hlocation;
				}).attr("y", function (d) {
				...
				// items elems exit
				itemsElems.exit().select('text').remove();
			} // render
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parseFloat = __webpack_require__(87);
	...
	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsRendererLanes = global.d3ringsRendererLanes || {});
	})(undefined, function (exports) {
		'use strict';
		...
		function coordsUtils() {
			...
			function horizontal_center(x1, x2) {
				if (x1 > x2) return (x2 - x1) / 2 + x1;else return (x1 - x2) / 2 + x2;
			}
			function horizontal_percent_to_coord(svg, percent) {
				...
				return xScrollWidth * (0, _parseFloat2.default)(percent) / 100;
			}
			function horizontal_coord_to_percent(svg, length) {
				var xScrollWidth = svg.property("scrollWidth");
				return (0, _parseFloat2.default)(length) / xScrollWidth;
			}
		...
		function arrayUtils() {
			function flattenArrByObjProp(a, p) {
				return a.reduce(function (prevArr, currVal, i, a) {
					if (prevArr.indexOf(currVal[p]) < 0) var r = prevArr.push(currVal[p]);
					return prevArr;
				}, []);
			}
		...
		function renderer(store) {
			...
			// return on same data
			if ((0, _stringify2.default)(stateLanes.reducerLanes.records) === (0, _stringify2.default)(newState.reducerLanes.records)) {
				return;
			}
			...
			// SVG
			var svgContainer = d3.select('body').selectAll('svg').data(['lanes_svg'], function (d) {
				return 'lanes_svg';
			});

			var newSvgContainer = svgContainer.enter().append("svg").attr("id", "lanes_svg");

			var laneGroup = svgContainer.selectAll('g.lane').data(['lane']).style('opacity', _opacity);

			laneGroup.enter().append("g").classed("lane", true);

			var runnersGroup = laneGroup.selectAll('g.runners').data(['runners']);

			runnersGroup.enter().append("g").classed("runners", true);

			var lanesGroup = laneGroup.selectAll('g.lanes').data(['lanes']);

			lanesGroup.enter().append("g").classed("lanes", true);

			var markerInstance = laneGroup.select(".runner-marker");
			if (markerInstance.node() == null) {
				laneGroup.append("marker").attr("id", "runner-marker").attr("class", "runner-marker").attr("viewBox", "0 0 10 10").attr("refX", "10").attr("refY", "5").attr("markerWidth", "5").attr("markerHeight", "4").attr("orient", "auto").append("path").attr("class", "runner-arrow").attr("d", "M 0 0 L 10 5 L 0 10 z");
			}

			var _laneItems0 = arrayUtils().array_names_from_props(_runners0, _itemProps);

			var _laneObjs0 = _laneItems0.map(function (d, i) {
				return { id: d,
					name: d,
					x0: parseFloat(coordsUtils().hcoord_pct(_laneItems0, d) * parseInt(svgContainer.style("width")) / 100).toFixed(0) };
			});
			...
			var _lanesObj0 = _laneItems0.reduce(function (total, d, currentIndex, arr) {
				...
				o[d] = { name: d,
					x0: parseFloat(coordsUtils().hcoord_pct(_laneItems0, d) * parseInt(svgContainer.style("width")) / 100).toFixed(0) };
				return (0, _assign2.default)({}, total, o);
			}, {});

			var _laneItems1 = arrayUtils().array_names_from_props(_runners1, _itemProps);
			...
			// laneElems trasition
			var d3ringsTransition = d3.transition().duration(_fadeTime).ease(d3.easeLinear);

			// laneElements DATA
			var laneElements = svgContainer.select("g.lanes").selectAll("g.lane").data(_laneObjs1, function (d) {
				return d.id;
			});

			// laneElements EXIT
			laneElements.exit().transition(d3ringsTransition).style("opacity", function (d) {
				store.dispatch(actions.deleteLane(d));
				return 0;
			}).remove(function () {});

			// laneElements UPDATE	texts
			var laneTexts = laneElements.select("text").attr("text-anchor", "middle").attr("alignment-baseline", "middle").style("font-size", function (d, i) {
				return parseInt(svgContainer.style("width")) * 2 / 100;
			}).text(function (d) {
				return d.name;
			}).attr("dy", "20").transition(d3ringsTransition).attr("x", function (d, i) {
			...
			var laneLines = laneElements.select("line").attr("x0", function (d, i) {
				var r = parseFloat(coordsUtils().hcoord_pct(_laneItems0, d.name) * parseInt(svgContainer.style("width")) / 100).toFixed(0);
				return r;
			}).attr("y1", function () {
				var text_bbox = this.parentNode.querySelector("text").getBBox();
				return text_bbox.y + text_bbox.height;
			}).attr("y2", "100%").transition(d3ringsTransition).attrTween("x1", function (d, i, a) {
				return function (t) {
					var r = parseFloat(coordsUtils().hcoord_pct(_laneItems1, d.name) * parseInt(svgContainer.style("width")) / 100).toFixed(0);
			...
			var newLaneElements = laneElements.enter().append("g").classed("lane", true);

			// newLaneElements ENTER text
			newLaneElements.append("text").attr("class", "lane").attr("text-anchor", "middle").attr("alignment-baseline", "middle").style("font-family", "sans-serif").style("fill", "transparent").style("font-size", function (d, i) {
				return parseInt(svgContainer.style("width")) * 2 / 100;
			}).text(function (d) {
				return d.name;
			}).attr("dy", "20").attr("x", function (d, i, a) {
				var r = coordsUtils().hcoord_tagged_pct(_laneItems1, d.name);
				return r;
			}).transition(d3ringsTransition).style("fill", "black").on("start", function start() {
				intransition = true;
			}).on("end", function end() {
				intransition = false;
			});
			...
			newLaneElements.append("line").attr("class", "lane").attr("stroke", "lightgray").style("stroke-width", "1px").attr("stroke-width", 1).attr("x0", function (d, i) {
				var r = parseFloat(coordsUtils().hcoord_pct(_laneItems0, d.name) * parseInt(svgContainer.style("width")) / 100).toFixed(0);
				return r;
			}).attr("x1", function (d, i, a) {
				var r = coordsUtils().hcoord_tagged_pct(_laneItems1, d.name);
				var x = parseFloat(coordsUtils().hcoord_pct(_laneItems1, d.name) * parseInt(svgContainer.style("width")) / 100).toFixed(0);
				var l = { name: d.name, id: d.id, x: x };
				store.dispatch(actions.setLane(l));
				return r;
			...
			// runnerElements										
			var runnerElements = svgContainer.select("g.runners").selectAll("g.runner").data(_runners1, function (d, i) {
				return d.id || (d.id = ++i);
			});

			// runner elems UPDATE texts
			runnerElements.select('text').transition(d3ringsTransition).attr("x", function (d, i) {
			...
			runnerElements.select('line').transition(d3ringsTransition).attr("x1", function (d, i, a) {
			...
			runnerElements.select("path").transition(d3ringsTransition).attr("d", function (d, i) {
				var x_pc = coordsUtils().hcoord_tagged_pct(_laneItems1, d.from);
				var xScrollWidth = parseInt(svgContainer.style("width"));
				var t = xScrollWidth * (0, _parseFloat2.default)(x_pc) / 100;
				var x = t;
				var rx = 40;
				var ry = 20;
				var y = (i + 2) * 50 - ry;
				var sweep_flag = 1;
				var r = ["M", x, y, "a", rx, ry, 0, 1, sweep_flag, 0, ry * 2].join(" ");
				return r;
			}).on("start", function start() {
				intransition = true;
			}).on("end", function end() {
			...
			// runnerElems ENTER
			var newMessageElements = runnerElements.enter().append("g").classed("runner", true);

			// runnerElems ENTER TEXTs
			newMessageElements.each(function (d, i) {
				var new_runner = d3.select(this).append("text").attr("class", "runner").style("fill", "transparent").style("font-size", function (d, i) {
					return parseInt(svgContainer.style("width")) * 2 / 100;
				}).attr("dy", ".15em").attr("text-anchor", d.from == d.to ? "end" : "middle").attr("alignment-baseline", d.from == d.to ? "middle" : "autoMode").text(d.msg).attr("y", (i + 2) * state.reducerConfig.vstep - 10).attr("x", function () {
					...
					return r;
				}).transition(d3ringsTransition).style("fill", "grey").on("start", function start() {
					intransition = true;
				}).on("end", function end() {
					intransition = false;
				});
			...
			newMessageElements.each(function (d, i) {
				...
				if (d.from == d.to) {
					...
					.attr("fill-opacity", 0).attr("stroke", "transparent").each(function (d) {
						// this._current = d_to_arc(d, i); // store initial state
					}).attr("d", function () {
						var x_pc_to = coordsUtils().hcoord_pct(_laneItems1, d.to);
						var xScrollWidth = parseInt(svgContainer.style("width"));
						var t = xScrollWidth * (0, _parseFloat2.default)(x_pc_to) / 100;
						var x = t;
						var rx = 40;
						var ry = 20;
						var y = (i + 2) * 50 - ry;
						...
						var r = ["M", x, y, "a", rx, ry, 0, 1, sweep_flag, 0, ry * 2].join(" ");
						return r;
					}).transition(d3ringsTransition).attr("stroke", "grey").attr("fill", "grey").attrTween("marker-end", function (d) {
						return function (t) {
							if (t != 1) {
								return null;
							} else {
					...
					// runnerElems ENTER LINEs
						...
						var line = new_runner.append("line").attr("class", "runner").attr("stroke", "transparent").attr("stroke-width", 1).attr("y1", function () {
							var r = (i + 2) * state.reducerConfig.vstep;
							return r;
						}).attr("y2", function () {
							var r = (i + 2) * state.reducerConfig.vstep;
							return r;
						}).attr("x1", coordsUtils().hcoord_tagged_pct(_laneItems1, d.from)).attr("x2", coordsUtils().hcoord_tagged_pct(_laneItems1, d.to)).transition(d3ringsTransition).attr("stroke", "gray").attr("fill", "grey").attrTween("marker-end", function () {
							return function (t) {
								if (t != 1) {
									return null;
								} else {
			...
			// runnerElems EXIT
			runnerElements.exit().transition().style("opacity", 0).remove();
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsRendererParticles = global.d3ringsRendererParticles || {});
	})(undefined, function (exports) {
		'use strict';
		...
		function renderer(store) {
			...
			var svgContainer = d3.select('body').selectAll('svg').data(['svgContainer']);

			svgContainer.enter().append("svg").attr("id", state.reducerConfig.container);

			svgContainer.style('width', state.reducerCourt.svgWidth).style('height', state.reducerCourt.svgHeight);

			var itemsGroup = d3.select('svg').selectAll('g.particles') // items
			.data(['items']);

			itemsGroup.enter().append("g").classed("particles", true); // items

			// _________________________________ render Particles	
			var color = d3.scalePlasma().domain([0, 1]);

			var particleElements = svgContainer.select("g.particles").selectAll("circle").data(state.reducerParticles.particles).attr('cx', function (d, i, a) {
				return d.x;
			}).attr('cy', function (d, i, a) {
				return d.y;
			...
			}).style("fill-opacity", 0.2).style("stroke", "none");

			var newParticleElements = particleElements.enter().append("circle").attr('cx', function (d, i, a) {
				return d.x;
			}).attr('cy', function (d, i, a) {
				return d.y;
			}).attr('r', function (d, i, a) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsRendererWhirls = global.d3ringsRendererWhirls || {});
	})(undefined, function (exports) {
		'use strict';
		...
		function renderer(store) {
			...
			// SVG
			var svgContainer = d3.select('body').selectAll('svg').data(['rangs_svg'], function (d) {
				return 'rangs_svg';
			});

			var newSvgContainer = svgContainer.enter().append("svg").attr("id", 'rangs_svg');

			svgContainer.style('width', _width).style('height', _height);

			d3.select('svg').selectAll('g.rangs') // items
			.data(['items']).style('opacity', _opacity).enter().append("g").classed("rangs", true); // items

			// rings
			d3.select('svg').selectAll('g.rings') // items
			.data(['items']).enter().append("g").classed("rings", true); // items

			// http://bl.ocks.org/brattonc/b1abb535227b2f722b51.
			var dummyText = svgContainer.select(".dummyText");
			if (dummyText.node() == null) {
				dummyText = svgContainer.append("text").attr("id", "dummyText").attr("class", "dummyText").text("N");
			}
			var textHeight = dummyText.node().getBBox().height;

			// elems trasition
			var elemsTransition = d3.transition().duration(_duration).ease(d3.easeLinear);

			var rangsTransition = d3.transition().duration(_duration).ease(d3.easeLinear);

			var elemsTransition = d3.transition().duration(_duration).ease(d3.easeLinear);

			var colorScale = d3.scaleCubehelix().domain([0, 1]);

			// _________________________________ render rangs

			var rangGroups = svgContainer.select("g.rangs") // data rang
			.selectAll("g.rang").data(gen(_n, _width, _height, _s), function (d) {
				return d.rid;
			});

			var newRangGroups = rangGroups // enter rang
			.enter().append("g").attr("class", "rang")
			...
			.attr("rid", function (d) {
				return d.rid;
			}).attr("grid", function (d) {
				return d.grid;
			}).attr("class", "rect").attr("x", function (d) {
				return d.x;
			}).attr("y", function (d) {
				return d.y;
			}).attr("s", function (d) {
				...
				return d.t;
			}).attr("stroke-width", 1).attr("stroke", "grey").style("fill", "transparent");
			...
			if (intransition_updRang == false) {
				...
				.attr("rid", function (d) {
					...
					return d.s;
				}).transition('updRang').duration(_duration).ease(d3.easeLinear).attrTween("height", function (d) {
					return function (t) {
			...
			var ringElements = svgContainer.select("g.rings").selectAll("circle").data(state.reducerWhirls.rings, function (d) {
				return d.id;
			});

			var updateItems = ringElements.attr('r', function (d, i, a) {
				return d.r;
				...
				return colorScale(Math.random() / 2);
			}).style("fill-opacity", 0.7).style("stroke", "none");

			var newRingElements = ringElements.enter().append("circle").attr('class', 'ring').attr('id', function (d, i, a) {
				return d.id;
			});

			newRingElements.transition('newRing').duration(_duration).ease(d3.easeLinear).attrTween('t', function (d, i, a) {
				return function (t) {
					store.dispatch(actions.tickRing((0, _assign2.default)({}, d, { t: t })));
					return t;
				};
			});

			var exitRingElements = ringElements.exit().remove(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
	  var d3ringsReducerConfig = __webpack_require__(100);
	  var d3ringsReducerCourt = __webpack_require__(107);
	  var d3ringsReducerDebug = __webpack_require__(108);
	  var d3ringsReducerLanes = __webpack_require__(109);
	  var d3ringsReducerParticles = __webpack_require__(120);
	  var d3ringsReducerWhirls = __webpack_require__(121);
	  // var d3ringsReducerRangs = require('./d3rings-reducer-rangs.js')
	  // var d3ringsReducerRings = require('./d3rings-reducer-rings.js')
	}

	(function (global, factory) {
	  ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsReducer = global.d3ringsReducer || {});
	})(undefined, function (exports) {
	  'use strict';
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
			( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsReducerConfig = global.d3ringsReducerConfig || {});
	})(undefined, function (exports) {
			'use strict';
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
		var d3ringsActionsCourt = __webpack_require__(102);
		var d3ringsActionsDebug = __webpack_require__(103);
		var d3ringsActionsLanes = __webpack_require__(104);
		var d3ringsActionsParticles = __webpack_require__(105);
		var d3ringsActionsWhirls = __webpack_require__(106);
	}

	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsActions = global.d3ringsActions || {});
	})(undefined, function (exports) {
		'use strict';
		...
		function merge_objects(ctt1, ctt2) {
			...
			for (i = 0; i < arguments.length; i++) {
				(0, _assign2.default)(obj, arguments[i]);
			}
			return obj;
		}

		var ActionTypes = merge_objects(d3ringsActionsCourt.ActionTypes, d3ringsActionsDebug.ActionTypes, d3ringsActionsLanes.ActionTypes, d3ringsActionsParticles.ActionTypes, d3ringsActionsWhirls.ActionTypes);

		var ActionCreators = merge_objects(d3ringsActionsCourt.ActionCreators, d3ringsActionsDebug.ActionCreators, d3ringsActionsLanes.ActionCreators, d3ringsActionsParticles.ActionCreators, d3ringsActionsWhirls.ActionCreators);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	  ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsActionsCourt = global.d3ringsActionsCourt || {});
	})(undefined, function (exports) {
	  'use strict';
	  ...
	  var keyMirror = function keyMirror(obj, prefix) {
	    var ret = {};
	    var key;
	  ...
	  var ActionCreators = {
	    ...
	    resizeScreen: function resizeScreen(width, height) {
	      return {
	    ...
	    releaseKeybKey: function releaseKeybKey(keyCode) {
	      return {
	        type: ActionTypes.RELEASE_KEYBKEY,
	        keyCode: keyCode
	      };
	    },
	    setKeybKey: function setKeybKey(keyCode) {
	      return {
	        type: ActionTypes.SET_KEYBKEY,
	        keyCode: keyCode
	      };
	    },
	    setMode: function setMode(currentMode) {
	      return {
	    ...
	    setView: function setView(currentView) {
	      return {
	        type: ActionTypes.SET_VIEW,
	        currentView: currentView
	      };
	    },
	    startKeybKeyEvents: function startKeybKeyEvents() {
	      return {
	        type: ActionTypes.START_KEYBKEY_EVENTS // startKeybKeyEvents
	      };
	    },
	    updateMousePos: function updateMousePos(x, y) {
	      return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	  ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsActionsDebug = global.d3ringsActionsDebug || {});
	})(undefined, function (exports) {
	  'use strict';
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	    ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsActionsLanes = global.d3ringsActionsLanes || {});
	})(undefined, function (exports) {
	    'use strict';
	    ...
	    var ActionCreators = {
	        decreaseCursorLow: function decreaseCursorLow() {
	            return {
	                type: ActionTypes.DECREASE_CURSOR_LOW
	            };
	        },
	        decreaseCursorHigh: function decreaseCursorHigh() {
	            return {
	                type: ActionTypes.DECREASE_CURSOR_HIGH
	            };
	        },
	        deleteLane: function deleteLane(lane) {
	            return {
	                type: ActionTypes.DELETE_LANE,
	                lane: lane
	            };
	        },
	        setRecordsFetched: function setRecordsFetched(areRecordsFetched) {
	            return {
	                type: ActionTypes.SET_RECORDS_FETCHED,
	                areRecordsFetched: areRecordsFetched
	            };
	        },
	        setRecords: function setRecords(argObj) {
	            // SET_RECORDS
	            return {
	        ...
	        setRecordsCollection: function setRecordsCollection(obj) {
	            // SET_RECORDS_COLLECTION
	            return {
	        ...
	        setLane: function setLane(lane) {
	            return {
	                type: ActionTypes.SET_LANE,
	                lane: lane
	            };
	        },
	        setLanes: function setLanes(lanes) {
	            return {
	        ...
	        walkDownRecords: function walkDownRecords(itemSpan, mode) {
	            // WALK_DOWN_RECORDS
	            return {
	        ...
	        walkUpRecords: function walkUpRecords(itemSpan, mode) {
	            // WALK_UP_RECORDS
	            return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsActionsParticles = global.d3ringsActionsParticles || {});
	})(undefined, function (exports) {
	   'use strict';
	   ...
	   var ActionCreators = {
	      createParticles: function createParticles(obj) {
	         var action = {
	      ...
	      introduceParticles: function introduceParticles(obj) {
	         return {
	      ...
	      tickParticles: function tickParticles(arg) {
	         return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsActionsWhirls = global.d3ringsActionsWhirls || {});
	})(undefined, function (exports) {
	   'use strict';
	   ...
	   var ActionCreators = {
	      deleteRang: function deleteRang(rang) {
	         return {
	            type: ActionTypes.DELETE_RANG,
	            rang: rang
	         };
	      },
	      startRangs: function startRangs() {
	         return {
	      ...
	      stopRangs: function stopRangs() {
	         return {
	            type: ActionTypes.STOP_RANGS
	         };
	      },
	      setRang: function setRang(rang) {
	         return {
	            type: ActionTypes.SET_RANG,
	            rang: rang
	         };
	      },
	      setRangs: function setRangs(rangs) {
	         return {
	            type: ActionTypes.SET_RANGS,
	            rangs: rangs
	         };
	      },
	      updateRangsDuration: function updateRangsDuration(obj) {
	         return {
	      ...
	      updateRangsNumber: function updateRangsNumber(obj) {
	         return {
	      ...
	      introduceRings: function introduceRings(obj) {
	         return {
	      ...
	      createRings: function createRings(obj) {
	         return {
	      ...
	      deleteRing: function deleteRing(ring) {
	         return {
	            type: ActionTypes.DELETE_RING,
	            ring: ring
	         };
	      },
	      startRings: function startRings() {
	         return {
	            type: ActionTypes.START_RINGS
	         };
	      },
	      startRingsTicker: function startRingsTicker() {
	         return {
	            type: ActionTypes.START_RINGS_TICKER
	         };
	      },
	      stopRingsTicker: function stopRingsTicker() {
	         return {
	            type: ActionTypes.STOP_RINGS_TICKER
	         };
	      },
	      tickRing: function tickRing(arg) {
	         return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
	    var d3 = __webpack_require__(1);
	    var d3ringsActions = __webpack_require__(102);
	}

	(function (global, factory) {
	    ( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsReducerCourt = global.d3ringsReducerCourt || {});
	})(undefined, function (exports) {
	    'use strict';
	    ...
	    function reducerCourt() {
	        var state = arguments.length <= 0 || arguments[0] === undefined ? initialStateCourt : arguments[0];
	        var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
			var d3 = __webpack_require__(1);
			var d3ringsActions = __webpack_require__(103);
	}

	(function (global, factory) {
			( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsReducerDebug = global.d3ringsReducerDebug || {});
	})(undefined, function (exports) {
			'use strict';
			...
			function reducerDebug() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? initialStateDebug : arguments[0];
					var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
		var d3 = __webpack_require__(1);
		var d3ringsActions = __webpack_require__(104);
	}

	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsReducerLanes = global.d3ringsReducerLanes || {});
	})(undefined, function (exports) {
		'use strict';
		...
		function reducerLanes() {
			var state = arguments.length <= 0 || arguments[0] === undefined ? initialStateLanes : arguments[0];
			var action = arguments[1];
			...
			switch (action.type) {
				case ActionTypes.DELETE_LANE:
					...
					var r = (0, _assign2.default)({}, state, { lanes: ls }, { lanesIndex: ls.length });
					return r;

				case ActionTypes.SET_LANE:
					// setLane
					var lanes = state.lanes;
					var ls = {};
					...
					if (result.length === 0) {
						...
						ls = { lanes: [{
								...
								x: action.lane.x
							}].concat((0, _toConsumableArray3.default)(lanes)) };
					} else {
						// edit
						ls = { lanes: lanes.map(function (lane) {
								return lane.id === action.lane.id ? (0, _assign2.default)({}, lane, { id: action.lane.id, name: action.lane.name, x: action.lane.x }) : lane;
							}) };
					}

					var r = (0, _assign2.default)({}, state, ls, {
				...
				case ActionTypes.SET_LANES:
					...
					return (0, _assign2.default)({}, state, {
						lanes: action.lanes,
						lanesIndex: (0, _keys2.default)(action.lanes).length
					});
				case ActionTypes.FETCH_RECORDS:
					...
					var processData = function processData(error, dataCsv) {
						if (store.getState().court.currentMode == 0) {
							// _tbd_ 
							++timeTick;
							++vLast;
							store.dispatch(actions.setMessages(store.getState().reducerConfig.recordsCollection.slice(0, store.getState().reducerConfig.recordsCollection.length)));
						}
					};
					d3.queue().defer(d3.csv, action.src, processRecord).await(processData);
				...
				case ActionTypes.SET_RECORDS_COLLECTION:
					...
					if (state.areRecordsFetched == false) {
						...
						var r = (0, _assign2.default)({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
			var d3 = __webpack_require__(1);
			var d3ringsActions = __webpack_require__(105);
	}

	(function (global, factory) {
			( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsReducerParticles = global.d3ringsReducerParticles || {});
	})(undefined, function (exports) {
			'use strict';
			...
			function reducerParticles() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? initialStateParticles : arguments[0];
					var action = arguments[1];

					if (action == null) return state;
					var ActionTypes = d3ringsActions.ActionTypes;
					switch (action.type) {
							case ActionTypes.START_PARTICLES:
									// startParticles
							...
							case ActionTypes.STOP_PARTICLES:
									// stopParticles
							...
							case ActionTypes.INTRODUCE_PARTICLES:
									// introduceParticles
									...
									if (state.particlesIntroduced == false && currentView == 'lanesView') {
											for (i = 0; i < numberOfNewParticles; i++) {
													...
													particle.vector = [particle.id % 2 ? -action.randNormal() : action.randNormal(), -action.randNormal2() * 3.3];
							...
							case ActionTypes.CREATE_PARTICLES:
									...
									if (particlesGenerating == true && currentView == 'lanesView') {
											for (var i = 0; i < numberOfNewParticles; i++) {
													...
													var closestLaneUp = action.lanes.filter(function (d) {
															return d.x >= ref;
													}).reduce(function (prev, curr) {
															return Math.abs(curr.x - ref) < Math.abs(prev.x - ref) ? curr : prev;
													}, { id: 'end', x: action.xEnd });

													var closestLaneDown = action.lanes.filter(function (d) {
															return d.x <= ref;
													}).reduce(function (prev, curr) {
															return Math.abs(curr.x - ref) < Math.abs(prev.x - ref) ? curr : prev;
							...
							case ActionTypes.TICK_PARTICLES:
									// tickParticles
									var laneXs = action.lanes.map(function (l) {
											var x = parseInt(l.x);
											return x;
									});
									...
									var movedParticles = state.particles.filter(function (p) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
			var d3 = __webpack_require__(1);
			var d3ringsActions = __webpack_require__(106);
	}

	(function (global, factory) {
			( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsReducerWhirls = global.d3ringsReducerWhirls || {});
	})(undefined, function (exports) {
			'use strict';
			...
			function reducerThis() {
					var state = arguments.length <= 0 || arguments[0] === undefined ? initialStateThis : arguments[0];
					var action = arguments[1];
					...
					switch (action.type) {
							...
							case ActionTypes.DELETE_RANG:
									...
									var r = (0, _assign2.default)({}, state, { rangs: items }, { rangsNow: items.length });
									return r;
							...
							case ActionTypes.SET_RANG:
									...
									if (result.length === 0) {
											// add rang
											items = { rangs: [(0, _defineProperty3.default)({
															id: action.rang.id,
															rid: action.rang.rid,
															...
															t: action.rang.t,
															sn: action.rang.s
													}, 's', s0)].concat((0, _toConsumableArray3.default)(rangs)) };
											rangsAlways = rangsAlways + 1;
									} else {
											// edit rang
											items = { rangs: rangs.map(function (rang) {
															return rang.rid === action.rang.rid ? (0, _assign2.default)({}, rang, {
																	rid: action.rang.rid,
																	grid: action.rang.grid,
																	x: action.rang.x,
																	y: action.rang.y,
									...
									var r = (0, _assign2.default)({}, state, items, { rangsNow: items.rangs.length,
							...
							case ActionTypes.SET_RANGS:
									...
									return (0, _assign2.default)({}, state, {
											rangs: action.rangs,
											rangsNow: (0, _keys2.default)(action.rangs).length
									});
							...
							case ActionTypes.UPDATE_RANGS_NUMBER:
									// updateRangsNumber
									var n = state.n;
									var hitsLostPct = Math.round(100 * (action.rangsAlways - action.rangsHitsIndex) / action.rangsAlways) || 0;
									...
									if (action.ringsGenerating == true) {
											...
											var _loop = function _loop() {
													...
													function inSquare(cx, cy, xl, yl, xh, yh) {
															if (cx > xl && cx < xh && cy > yl && cy < yh) return true;else return false;
													}

													xl = action.rangs[j].x;
													yl = action.rangs[j].y;
													xh = action.rangs[j].x + action.rangs[j].s;
													yh = action.rangs[j].y + action.rangs[j].s;
													...
													if (inSquare(cx, cy, xl, yl, xh, yh)) {
															...
															for (i = 0; i < action.ringsPerTick; i++) {
																	...
																	ring.vector = [ring.id % 2 ? -action.randNormal() : action.randNormal(), -action.randNormal2()];
							...
							case ActionTypes.DELETE_RING:
									...
									var r = (0, _assign2.default)({}, state, { rings: items }, { ringsIndex: items.length });
									return r;
							...
							case ActionTypes.TICK_RING:
									...
									var hitRangs = rangs.filter(function (d) {
											return d.id == action.ring.rid;
									});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsStore = global.d3ringsStore || {});
	})(undefined, function (exports) {
		'use strict';
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		( false ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.d3ringsControls = global.d3ringsControls || {});
	})(undefined, function (exports) {
		'use strict';
		...
		function tickControls(store, actions) {
			...
			ticker.start = function start() {
				var started = false;
				var main = function main(timestamp) {
